...
class TimerPickerHourMinutes extends StatefulWidget {
  const TimerPickerHourMinutes({super.key});

  @override
  State<TimerPickerHourMinutes> createState() => _TimerPickerState();
}

class _TimerPickerState extends State<TimerPickerHourMinutes> {
...
String get formattedDuration{
  ...
  return '${twoDigits(hours)} H ${twoDigits(minutes)}';
}
